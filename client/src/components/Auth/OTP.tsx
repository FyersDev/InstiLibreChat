...
function OTP() {
  ...
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-gradient-to-br from-[#2434E7] to-[#3B4FE8] p-6 sm:p-8 lg:p-12 flex flex-col min-h-[40vh] lg:min-h-screen overflow-y-auto">
        {/* Logo */}
        ...
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="hidden md:block bg-white/10 backdrop-blur-sm rounded-2xl p-4 lg:p-6 max-w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 mb-4 lg:mb-6 justify-center">
              {/* Document Analysis Card */}
              <div className="bg-white rounded-xl p-4 lg:p-6 flex flex-col w-full">
                ...
                <div className="space-y-2 lg:space-y-3 flex-1">
                  ...
                  <div className="bg-blue-500 rounded-lg p-2 lg:p-3">
                    <p className="text-xs lg:text-sm text-white">
                      The document discusses AI implementation strategies...
                    </p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-2 lg:p-3">
                    <p className="text-xs lg:text-sm text-gray-600">
