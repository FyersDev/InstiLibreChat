...
const UploadFileModal = ({ open, onOpenChange }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          'w-11/12 overflow-x-auto p-3 shadow-2xl bg-[#F7F7F7] dark:bg-[#222222] dark:text-white lg:w-2/3 xl:w-2/5',
        )}
      >
        <DialogHeader>
        ...
        <div className="flex w-full flex-col p-0 sm:p-6 sm:pb-0 sm:pt-4">
          ...
          <div className="mt-3 flex w-full flex-row justify-between">
            ...
            <div className="flex w-full flex-row justify-evenly sm:w-1/3">
              <Button
                className="mr-3 w-full rounded-md border border-black bg-white p-0 text-black hover:bg-gray-200"
                onClick={() => {
                  onOpenChange(false);
                }}
              >
              ...
              <Button
                className="w-full rounded-md border border-black bg-blue-600 p-0 text-white hover:bg-blue-700"
                onClick={() => {
