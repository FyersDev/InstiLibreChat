...
export const apiV1Catalog = {
  ...
  personasList: { method: 'GET' as const, path: '/api/v1/personas?limit=1000', usedIn: 'saasApi.getPersonas' },
  personasCreate: { method: 'POST' as const, path: '/api/v1/personas', usedIn: 'saasApi.createPersona' },
  personaById: { method: 'GET' as const, path: '/api/v1/personas/{id}', usedIn: 'saasApi.getPersona' },
  personaUpdate: { method: 'PUT' as const, path: '/api/v1/personas/{id}', usedIn: 'saasApi.updatePersona' },
